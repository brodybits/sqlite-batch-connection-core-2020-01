# SQLite object batch connection core
...
Straightforward SQLite batch processing library classes for Android and iOS
...
- `ios` - `SQLiteBatchCore` Objective-C module, using the C module described below
...
- Background threading would need to be done in a higher-level component, which should be straightfowrard on both Android and iOS.
