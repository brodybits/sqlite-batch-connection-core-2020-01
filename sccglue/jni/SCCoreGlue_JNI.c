 ...
 *     C function: int scc_bind_long(int connection_id, int index, scc_long value);
 */
JNIEXPORT jint JNICALL
Java_io_sqlc_SCCoreGlue_scc_1bind_1long__IIJ(JNIEnv *env, jclass _unused, jint connection_id, jint index, jlong value) {
  int _res;
  _res = scc_bind_long((int) connection_id, (int) index, (scc_long) value);
  return _res;
}
 ...
 *     C function: scc_long scc_get_column_long(int connection_id, int column);
 */
