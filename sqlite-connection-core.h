...
/**
 * This typedef is needed to help gluegen generate the C code
 * to use the correct data type.
 */
typedef long long scc_long;
...
int scc_bind_long(int connection_id, int index, scc_long value);
...
scc_long scc_get_column_long(int connection_id, int column);
